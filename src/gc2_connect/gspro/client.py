...
from gc2_connect.models import GC2ShotData, GSProShotMessage, GSProResponse
...
class GSProClient:
    ...
    def __init__(self, host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
        ...
        self._shot_number = 0
        self._current_player: Optional[dict] = None
    ...
    def send_shot(self, shot: GC2ShotData) -> Optional[GSProResponse]:
    ...
    def send_heartbeat(self) -> Optional[GSProResponse]:
    ...
    def _send_message(self, message: GSProShotMessage) -> Optional[GSProResponse]:
    ...
    async def send_shot_async(self, shot: GC2ShotData) -> Optional[GSProResponse]:
